                ...
                <div className="relative z-10 max-w-[90rem] mx-auto px-6 md:px-12 py-24">
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 lg:items-stretch">
                        ...
                        <div className="lg:w-[450px] flex flex-col">
                            <Card className="animate-float-1 flex-1 bg-white/5 border border-blue-500 text-white backdrop-blur-sm hover:border-indigo-500/40 hover:scale-105 hover:shadow-[0_0_40px_rgba(99,102,241,0.4)] transition-all duration-500">
                                <CardContent className="pt-8 flex flex-col items-center gap-6 h-full">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Avatar className="relative w-28 h-28 ring-1 ring-purple-400/50">
                                    ...
                                    {/* Divider */}
                                    <Separator orientation="horizontal" className="h-full bg-blue-500" />

                                    {/* Profile details */}
                                    <div className="w-full space-y-3">
                                        {profileDetails.map(({ label, value }) => (
                                            <div key={label} className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-3">
                                                <span className="text-xs font-semibold aldrich-regular uppercase tracking-widest text-indigo-400 sm:w-40 shrink-0">
                                                    {label}
                                                </span>
                                                <span className="text-sm aldrich-regular text-slate-300 font-medium">{value}</span>
                                            </div>
                                        ))}
                                    </div>
                                </CardContent>
